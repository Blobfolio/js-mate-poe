...
Vue.component("poe-sprite",{data:function(){return{frames:[],preset:-1,presets:t.reduce((a,b)=>{for(let c=0;c<b.b.length;++c){const e=r(b.b[c]);let f=null===e.repeat?0:Math.floor(e.repeat[0]);99<f&&(f=99);const k=f?Math.floor(e.repeat[1]):0;let w=b.name;0<c&&(w+=` (#${c+1})`);a.push({id:`${b.id}_${c}`,name:w,speed:Math.round(e.duration/u(e)),repeat:f,repeatFrom:k,frames:e.frames})}return a},[]).sort((a,b)=>{a=a.name.toLowerCase();b=b.name.toLowerCase();return a<b?-1:a>b?1:0}),repeat:0,repeatFrom:0,
...
new Vue({el:"#app",data:{name:"JS Mate Poe",version:"1.1.3",animations:t.reduce((a,b)=>{let c=b.flags;{var e=b.b;let f=[];for(let k=0;k<e.length;++k)f.push(r(e[k]));e=f}a.push({id:b.id,name:b.name,scenes:e,flags:c,childId:null===b.c?0:b.c,edge:q(b.f),next:q(b.next)});return a},[]).sort((a,b)=>`${1&a.flags?"0_":"1_"}${a.name}`<`${1&b.flags?"0_":"1_"}${b.name}`?-1:1),immersive:!1,tab:"animations",tabs:[{id:"animations",name:"Animations"},{id:"sprite",name:"Sprite"}]},mounted:function(){A||(A=!1)},methods:{immersiveToggle:function(a){this.immersive=
!!a;document.body.classList.toggle("is-immersive",this.immersive);this.tab=this.immersive?"immersive":"animations"},playAnimation:function(a){window.Poe.animation=a},summary:function(a){return"undefined"!==typeof this.summaries[a]?this.summaries[a]:!1},tabToggle:function(a){this.tab=a}},computed:{summaries:function(){return this.animations.reduce((a,b)=>{a[b.id]={id:b.id,name:b.name,frame:b.scenes[0].frames[0]};return a},{})}}});}).call(this);
